...
Route::patch('/vehicle/{vehicle}', 'VehicleController@update')->name('vehicle.update')->middleware(['verified','auth:sanctum']);
Route::post('/vehicle', 'VehicleController@store')->name('vehicle.store')->middleware(['verified','auth:sanctum']);;
Route::get('/', 'VehicleController@index')->name('vehicle.index');
Route::delete('/vehicle/{vehicle}', 'VehicleController@destroy')->name('vehicle.destroy')->middleware(['verified','auth:sanctum']);
