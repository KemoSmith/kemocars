<template>
	<div id="sticky-slider" class="sticky-top" style="z-index: 10;">
		<v-img
			:aspect-ratio="16/9"
			class="grey darken-3"
			:src="imageFromDeletable ? delatableImages[selectedImageIndex].path : vehicleFormImages[selectedImageIndex]"
		></v-img>
		<div id="image-select" class="d-flex pl-3 pt-3">
			<v-card
				...
				:key="i"
				@click="() => {selectedImageIndex = i; imageFromDeletable = false }"
			>
				<v-img :aspect-ratio="16/9" class="grey darken-3" :src="image"></v-img>
			</v-card>
			<v-card
				ripple
				class="col-3 p-0 mr-3 mb-3 bg-transparent"
				...
				:key="i"
				@click="() => {selectedImageIndex = i; imageFromDeletable = true }"
			>
				<v-img :aspect-ratio="16/9" class="grey darken-3" :src="image.path"></v-img>
			...
			<v-card
				...
				class="col-3 p-0 mr-3 mb-3 bg-transparent"
			>
				<v-img :aspect-ratio="16/9" class="grey darken-3"></v-img>
			</v-card>
		</div>
	</div>
</template>
